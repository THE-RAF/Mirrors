/**
 * @file examples/diagonalReflection.js - Diagonal reflection example
 */

import { createStar, createDiamond, createPentagon } from '../utils/geometryFactory.js';

export const diagonalReflectionExample = {
    name: "Diagonal Reflection",
    description: "Polygon reflections across a diagonal mirror line",
